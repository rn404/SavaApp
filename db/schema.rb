...
ActiveRecord::Schema.define(version: 20170428093035) do
  ...
  create_table "chara_weapons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "chara_id"
    t.integer  "weapon_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "weapons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string   "name"
  end
